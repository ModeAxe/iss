    ...
    useEffect(() => {
        ...
        const compositeNode = {
            ...
            connect: (dest, outputNum, inputNum) => {
                console.log(`[SpaceWeatherModule] Connecting output ${outputNum} to`, dest, `input: ${inputNum}`);
                try {
                    ...
                    if (!actualDest) {
                        console.error('[SpaceWeatherModule] Could not resolve destination node');
                        return;
                    }
                    ...
                    console.error('[SpaceWeatherModule] Connect Error:', err);
                }
            },
            disconnect: (dest) => {
